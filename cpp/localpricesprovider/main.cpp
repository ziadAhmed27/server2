...
// Configuration
const std::string SERVER_BASE_URL = "https://server2-production-3173.up.railway.app"; // Update with your server URL
...
const std::string PYTHON_SCRIPT = "pyApp\\priceAssistant.py";
